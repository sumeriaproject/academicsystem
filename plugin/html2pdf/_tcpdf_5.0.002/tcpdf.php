...
if (!class_exists('TCPDF', false)) {
	...
	*/
	class TCPDF {
		...
		/**
		 * String used to mark the beginning and end of EPS image components
		 * @access protected
		...
		/**
		 * Array used to store positions of graphics transformation components inside the page buffer.
		 * keys are the page numbers
		 * @access protected
		...
		public function getNumLines($txt, $w=0) {
			...
			// divide text in components
			$txtcomponents = explode("\n", $txt);
			// for each text block
			foreach ($txtcomponents as $block) {
