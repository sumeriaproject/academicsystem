...
class orderArray{
	...
	public function orderKeyBy($array,$key){
		if(is_array($array)){
			$newArray=array();
	...
	public function orderMultiKeyBy($array,$key){
		$newArray=array();
    if(is_array($array)){
      foreach($array as $name=>$value){
        $newArray[strtoupper(trim($value[$key]))][]=$array[$name];
      }
    }
		return $newArray;
	}
	...
	public function orderTwoKeyBy($array,$key,$key2){
		$newArray=array();
    if(is_array($array)){
      foreach($array as $name=>$value){
	...
	public function orderMultiTwoKeyBy($array,$key,$key2){
		$newArray=array();
		foreach($array as $name=>$value){
			$newArray[$value[$key]][$value[$key2]][]=$array[$name];
		}
	...
	public function getMuncipiosColombia($depto){
    $tsCiudades = array( 
        1 => array( 
            1 => 'LETICIA', 
            2 => 'EL ENCANTO', 
    ...
    return json_encode($tsCiudades[$depto]);
  }
	public function getDeptosColombia(){
