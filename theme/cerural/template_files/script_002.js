...
jQuery(function($) {
    ...
    $('#block-system-main form.art-search #edit-basic input[type="submit"]').insertAfter(text).css('height', 'auto').css('top', parseInt(text.css('top')) + parseInt(text.css('padding-top')) + parseInt(text.css('height')));
});
