...
class AesCtr extends Aes {
  ...
  public static function encrypt($plaintext, $password, $nBits) {
    ...
    for ($b=0; $b<$blockCount; $b++) {
      ...
      // done in two stages for 32-bit ops: using two words allows us to go past 2^32 components (68GB)
  ...
  public static function decrypt($ciphertext, $password, $nBits) {
    ...
    // separate ciphertext into components (skipping past initial 8 bytes)
    ...
    // join array of components into single plaintext string
